...
struct _3DLabs
{
    ...
    static void set_auto_pid_status(const FlashChar* message);
    static void set_auto_pid_status(const FlashChar* fmt, va_list& args);
    static void set_auto_pid_status_v(const FlashChar* fmt, ...);
