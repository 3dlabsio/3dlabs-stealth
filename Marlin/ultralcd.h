...
#include "3dlabs.h"
    ...
    inline void lcd_buzz(const long duration, const uint16_t freq) { _3dlabs::_3DLabs::buzz(duration, freq); }
    ...
    {
        _3dlabs::_3DLabs::advanced_pause_show_message(message);
    }

    inline void kill_screen(const char* msg) { _3dlabs::_3DLabs::set_status(msg); }
    ...
    inline void set_lcd_contrast(const int16_t value) { _3dlabs::_3DLabs::set_brightness(value); }
