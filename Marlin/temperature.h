...
class Temperature {
  ...
  public:
    ...
    static void setTargetHotend(const int16_t celsius, const uint8_t e) {
      ...
      _3dlabs::_3DLabs::on_set_temperature(e == 0 ? _3dlabs::TemperatureKind::Hotend1 : _3dlabs::TemperatureKind::Hotend2, celsius);
      #if WATCH_HOTENDS
    ...
    FORCE_INLINE static bool isCoolingHotend(const uint8_t e) {
      ...
      static void setTargetBed(const int16_t celsius) {
        ...
        target_temperature_bed =
          ...
          #endif
        ;
        _3dlabs::_3DLabs::on_set_temperature(_3dlabs::TemperatureKind::Bed, target_temperature_bed);
        #if WATCH_THE_BED
          start_watching_bed();
        #endif
      }
