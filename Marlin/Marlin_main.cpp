...
static millis_t max_inactive_time = 43200000; // = 12 hour default for the 3dlabs stealth;
...
void clean_up_after_endstop_or_probe_move() {
  ...
  float probe_pt(const float &rx, const float &ry, const ProbePtRaise raise_after/*=PROBE_PT_NONE*/, const uint8_t verbose_level/*=0*/, const bool probe_relative/*=true*/) {
    ...
    if (probe_relative) {
      ...
      // @advi3++
      nx -= (_3dlabs::_3DLabs::x_probe_offset_from_extruder());                     // Get the nozzle position
      ny -= (_3dlabs::_3DLabs::y_probe_offset_from_extruder());
    }
...
inline void gcode_G4() {
  ...
  inline void home_z_safely() {
    ...
    #if HOMING_Z_WITH_PROBE
      // @advi3++
      destination[X_AXIS] -= _3dlabs::_3DLabs::x_probe_offset_from_extruder();
      destination[Y_AXIS] -= _3dlabs::_3DLabs::y_probe_offset_from_extruder();
    #endif
...
void home_all_axes() { gcode_G28(true); }
  ...
  void abort_G29()
  {
	  _3dlabs::_3DLabs::g29_leveling_finished(false);
  }
  ...
  inline void gcode_G29() {
    ...
    if (!g29_in_progress) {
      ...
      ;
        ...
        left_probe_bed_position  = parser.seenval('L') ? int(RAW_X_POSITION(parser.value_linear_units())) : _3dlabs::_3DLabs::left_probe_bed_position();
        right_probe_bed_position = parser.seenval('R') ? int(RAW_X_POSITION(parser.value_linear_units())) : _3dlabs::_3DLabs::right_probe_bed_position();
        front_probe_bed_position = parser.seenval('F') ? int(RAW_Y_POSITION(parser.value_linear_units())) : _3dlabs::_3DLabs::front_probe_bed_position();
        back_probe_bed_position  = parser.seenval('B') ? int(RAW_Y_POSITION(parser.value_linear_units())) : _3dlabs::_3DLabs::back_probe_bed_position();
      ...
      measured_z = 0;
        ...
        for (uint8_t PR_OUTER_VAR = 0; PR_OUTER_VAR < PR_OUTER_END && !isnan(measured_z); PR_OUTER_VAR++) {
          ...
          for (int8_t PR_INNER_VAR = inStart; PR_INNER_VAR != inStop; PR_INNER_VAR += inInc) {
            ...
            // @advi3++: Display on the LCD panel the indexes of the measures
            _3dlabs::_3DLabs::set_auto_bed_leveling_progress(measure_index++, nb_measures,
    ...
    report_current_position();
    // @advi3++
    _3dlabs::_3DLabs::g29_leveling_finished(!isnan(measured_z));
  }
  ...
  inline void gcode_G30() {
    // @advi3++
    const float xpos = parser.linearval('X', current_position[X_AXIS] + _3dlabs::_3DLabs::x_probe_offset_from_extruder()),
                ypos = parser.linearval('Y', current_position[Y_AXIS] + _3dlabs::_3DLabs::y_probe_offset_from_extruder());
  ...
  inline void gcode_G42() {
    ...
    if (IsRunning()) {
      ...
      if (parser.boolval('P')) {
        // @advi3++
        if (hasI) destination[X_AXIS] -= _3dlabs::_3DLabs::x_probe_offset_from_extruder();
        if (hasJ) destination[Y_AXIS] -= _3dlabs::_3DLabs::y_probe_offset_from_extruder();
      }
...
void report_xyz_from_stepper_position() {
  ...
  inline void gcode_M0_M1() {
    ...
    // @advi3++: ADVi3++ is like a ULTIPANEL
      ...
      _3dlabs::_3DLabs::stop_and_wait(); // @advi3++: Display Wait screen
...
inline void gcode_M42() {
  ...
  inline void gcode_M48() {
    ...
    // @advi3++
    const float X_probe_location = parser.linearval('X', X_current + _3dlabs::_3DLabs::x_probe_offset_from_extruder()),
                Y_probe_location = parser.linearval('Y', Y_current + _3dlabs::_3DLabs::y_probe_offset_from_extruder());
      ...
      for (uint8_t n = 0; n < n_samples; n++) {
        if (n_legs) {
          ...
          for (uint8_t l = 0; l < n_legs - 1; l++) {
            ...
            // @advi3++
            X_current = X_probe_location - (_3dlabs::_3DLabs::x_probe_offset_from_extruder()) + cos(RADIANS(angle)) * radius;
            Y_current = Y_probe_location - (_3dlabs::_3DLabs::y_probe_offset_from_extruder()) + sin(RADIANS(angle)) * radius;
...
inline void gcode_M502() {
  ...
  inline void gcode_M600() {
    ...
    _3dlabs::_3DLabs::pause_finished();
  }
...
void process_parsed_command() {
  ...
  switch (parser.command_letter) {
	case 'A': _3dlabs::_3DLabs::process_command(parser); break; // @advi3++: Put back ADVi3++ own command codes
...
void setup() {
  ...
  _3dlabs::_3DLabs::setup_lcd_serial();
  ...
  _3dlabs::_3DLabs::change_baudrate();
